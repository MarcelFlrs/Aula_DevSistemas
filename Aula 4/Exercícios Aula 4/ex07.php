...
<?php 
    ...
    if($num1 > $num2 && $num1 > $num3){
        echo  "O maior número é o primeiro: " . $num1;
    }else if($num2 > $num3){
        echo "O maior número é o segundo: " . $num2;
    }else{
        echo "O maior número é o terceiro: " . $num3;
    }
    
        echo "<br>";

    if($num1 < $num2 && $num1 < $num3){
        echo  "<br>O menor número é o primeiro: " . $num1;
    }else if($num2 < $num3){
        echo "O menor número é o segundo: " . $num2;
    }else{
        echo "O menor número é o terceiro: " . $num3;
    }
